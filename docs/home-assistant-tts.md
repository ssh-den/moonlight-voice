...
4. Go to **Settings → Devices & services → Add integration**, choose **Moonlight Voice**, and enter the direct add-on URL. For this repository deployed through the local `addons` share, use `http://local-moonlight-voice:8031`.
